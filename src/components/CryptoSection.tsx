...
export default function CryptoSection() {
  return (
    <section id="crypto" className="relative bg-black min-h-screen overflow-hidden flex items-center justify-center">
      <div className="absolute top-1/2 left-0 w-200 h-200 bg-white/25 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 z-20" />
      <div className="absolute top-1/2 right-0 w-200 h-200 bg-white/25 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 z-20" />
