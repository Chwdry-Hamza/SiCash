...
export default function TransferSection() {
  return (
    <section id="transfer" className="relative bg-[#f5f0e6] py-32 overflow-hidden">
      {/* Content */}
      <div className="relative z-10 w-full max-w-380 mx-auto px-8 flex items-center justify-between">
        ...
        <div className="relative w-150 h-150">
          {/* Main Phone */}
          <div className="absolute top-0 right-0 w-72 h-[580px] bg-zinc-900 rounded-[50px] border-8 border-zinc-800 shadow-2xl overflow-hidden transform rotate-6">
            {/* Screen Content */}
