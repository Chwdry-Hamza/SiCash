...
export default function Footer() {
  return (
    <footer className="bg-black pt-16 pb-32">
      <div className="w-full max-w-420 mx-auto px-12">
        ...
        {/* <div className="flex flex-wrap justify-end gap-x-6 gap-y-2 mb-8">
          ...
          <a href="#" className="text-zinc-400 text-sm hover:text-white transition-colors">ACCEPTED ASSETS</a>
        </div> */}
              <div className="flex flex-wrap justify-end gap-x-6 gap-y-2 mb-8">
          <Link href="/#" className="text-zinc-400 text-sm hover:text-white transition-colors">ABOUT SICASH</Link>
          <Link href="/#" className="text-zinc-400 text-sm hover:text-white transition-colors">OTC DESK</Link>
          <Link href="/privacy-policy" className="text-zinc-400 text-sm hover:text-white transition-colors">PRIVACY POLICY</Link>
          <Link href="/cookie-policy" className="text-zinc-400 text-sm hover:text-white transition-colors">COOKIE POLICY</Link>
          <Link href="/#" className="text-zinc-400 text-sm hover:text-white transition-colors">TERMS & CONDITIONS</Link>
          <a href="#" className="text-zinc-400 text-sm hover:text-white transition-colors">ACCEPTED ASSETS</a>
        </div>
